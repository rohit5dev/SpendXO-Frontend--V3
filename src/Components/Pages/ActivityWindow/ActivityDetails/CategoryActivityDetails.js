  ...
  const fetchActivityDetails = async () => {
    try {
      const response = await axios.get(
        `${apiUrls.urlPrefix}/activity-window/category-activity-by-id/${Id}`,
        requestHeader.json
      );
          ...
          <div className="card-body">
            <div>
              <div className="d-flex justify-content-between align-items-center mb-4">
                <div className="d-flex align-items-center">
                  ...
                  <h5 className="card-title mb-0">
                    Category Tree Activity Details
                  </h5>
                </div>
                <span
                  style={{
              ...
              {[
                {
                  label: "L1 Category",
                  value: activityDetailsData?.L1Category || "N/A",
                },
                {
                  label: "L2 Category",
                  value: activityDetailsData?.L2Category || "N/A",
                },
                {
                  label: "L3 Category",
                  value: activityDetailsData?.L3Category || "N/A",
                },
                {
                  label: "L4 Category",
                  value: activityDetailsData?.L4Category || "N/A",
                },
                {
                  label: "Description",
                  value: activityDetailsData?.Description || "N/A",
                  multiline: true,
                },
                {
                  label: "Approver",
...
export default CategoryActivityDetails;
