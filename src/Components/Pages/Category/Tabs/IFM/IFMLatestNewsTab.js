...
const IMFLatestNewsTab = () => {
  ...
  const filteredNews = IFMTabsData?.newsData?.filter((data) => {
    const matchesSearch =
    ...
    <div className="commodity-data ">
      ...
      <div className="row g-2 pt-2">
        <div className="col-2">
          ...
          <div className="align-items-center gap-2 my-2">
            ...
            >
              ...
              {Array.from(
                new Set(
                  IFMTabsData?.newsData?.map((data) => data.classification)
                )
              ).map((category, index) => (
        ...
        <div className="col-7 pt-1">
          ...
          {/* {
            JSON.stringify(filteredNews.length)
          } */}
          <div
        ...
        <div className="col-3 pt-1">
          ...
          >
            ...
            <div className="d-flex flex-column gap-1">
              {IFMTabsData?.marketTrendData?.map((data, index) => {
                return (
                  <div
                    key={index}
                    className="d-flex flex-column rounded-2 px-3 py-2 shadow-sm mb-1"
...
export default IMFLatestNewsTab;
