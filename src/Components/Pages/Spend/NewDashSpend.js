...
const ImpactAnalysis = () => {
  ...
  return (
    <div>
      ...
      <iframe
        ref={iframeRef}
        src="https://app.powerbi.com/reportEmbed?reportId=f58d13b7-abec-4f6b-a6e6-3643e51c603f&autoAuth=true&ctid=55e0a09f-7836-4d37-b386-b5605b46a125"
        style={{
          width: "100%",
          height: "100vh",
          border: "none",
...
// Note: Ensure that the CSS for .full-scrn-button is defined to position it correctly
